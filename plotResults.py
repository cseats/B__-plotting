    ...
    for write in formats:
        for sheet in inputCSVs:
            ...
            if "tshell_FM" in sheet:
                sheet = addUtilztn.addUtilization_PropFrce(inputName,parentDir)
            elif "strain" in sheet:
                sheet = addCompTens.addCompTens(inputName,parentDir)
            elif "dowel_force" in sheet:
                sheet = addDowelFrce.calcDowelForce(inputName,parentDir)
