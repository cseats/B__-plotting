...
def getCurves(thickness):
    ...
    df = pd.read_csv(thickness+'in_interactionCurves.csv')
...
def addUtilization_PropFrce(inputCSV):
    ...
    for thickness in thicknessList:
        ...
        utilCFrc = []
        [curveDict,curves] = getCurves(thickness)
        xCurve1 = curves[curveDict["curve1"][0]]
        yCurve1 = list(curves[curveDict["curve1"][1]])
        xCurve2 = curves[curveDict["curve2"][0]]
        yCurve2 = list(curves[curveDict["curve2"][1]])
        xCurve3 = curves[curveDict["curve3"][0]]
        yCurve3 = list(curves[curveDict["curve3"][1]])
        xCurve4 = curves[curveDict["curve4"][0]]
        yCurve4 = list(curves[curveDict["curve4"][1]])


        addTraceLine(xCurve3,yCurve3,fig,"Curve3"+thickness)
        addTraceLine(xCurve4,yCurve4,fig,"Curve4"+thickness)
        ...
        addTraceLine(xCurve4,yCurve4,fig,"Curve4"+thickness)
        fig.show()
        df.to_csv(inputCSV+thickness+'thick With UtilizationCurveNew.csv')
